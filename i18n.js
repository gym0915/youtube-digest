var YTD_I18N = (() => {
  ...
  const COPY = Object.freeze({
    en: {
      ...
      "sidepanel.contentTranslationControls": "Content translation controls",
      "sidepanel.contentTranslationMode": "Content translation mode",
      ...
      "contentTranslation.waiting": "Waiting for translation…",
      "contentTranslation.retrying": "Retrying…",
      "contentTranslation.retry": "Retry",
      "contentTranslation.unavailable": "Translation unavailable.",
      "contentTranslation.failed": "Translation failed.",
      ...
      "overview.removeQuoteTitle": "Remove this quote from notes",
      ...
      "overview.removeQuoteFailed":
        "Could not remove this quote from notes. Try again.",
      ...
      "notes.copyTextToast": "Copied text",
      "notes.copyTimestampToast": "Copied timestamp",
      "notes.play": "Play",
    ...
    "zh-CN": {
      ...
      "sidepanel.contentTranslationControls": "内容翻译控制",
      "sidepanel.contentTranslationMode": "内容翻译模式",
      ...
      "contentTranslation.waiting": "正在等待翻译…",
      "contentTranslation.retrying": "正在重试…",
      "contentTranslation.retry": "重试",
      "contentTranslation.unavailable": "暂无法翻译。",
      "contentTranslation.failed": "翻译失败。",
      ...
      "overview.removeQuoteTitle": "从笔记中移除此引文",
      ...
      "overview.removeQuoteFailed": "无法从笔记中移除此引文，请重试。",
      "overview.saveQuoteFailedWithError": ({ error }) =>
        `无法保存此引文：${error}`,
      ...
      "notes.copyTextToast": "已复制文本",
      "notes.copyTimestampToast": "已复制时间戳",
      "notes.play": "播放",
